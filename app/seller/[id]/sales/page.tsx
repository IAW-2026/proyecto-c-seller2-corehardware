...
export default async function SellerSales({ params }: { params: Promise<{ id: string }> }) {
        ...
        <section className="rounded-4xl border border-zinc-200 bg-white/95 p-8 shadow-2xl shadow-zinc-200/30 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950 dark:shadow-black/20">
          <div className="flex flex-col gap-8 text-center sm:text-left">
            <div className="space-y-4">
              <p className="text-sm uppercase tracking-[0.3em] text-indigo-600">Panel de ventas</p>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              <Link href={`/seller/${id}/sales/allSales`}>
              ...
              <Link href={`/seller/${id}/sales/salesByPeriod`}>
              ...
              <Link href={`/seller/${id}/sales/lastSales`}>
